...
const { getstaffcomplaints } = require("../controllers/staffcontrollers.js");


const getcomplaintstatsforuser = async (userId)=>{
...
const getcomplaintforuser = async (userId)=>{
        let query = supabase
          .from('complaints')
          .select('*')
          .eq('user_id', userId);
...
const submitnewcomplaint = async (file,complaintdata)=>{
...
const departmentcomplaints = async (id)=>{
...
const updatecomplaint = async(id,status,userId,userFullname)=>{
...
const deletedbcomplaint = async(compid)=>{
...
const getadmincomplaintsallocation = async()=>{
      const { data: complaints, error } = await supabase
      .from('complaints')
      .select('*')
      .eq('status','pending')
...
const getadmincomplaintsallocate = async(compid,staffid)=>{
...
const docomplaintsedit = async(complaintId,editform)=>{
...
module.exports = {
  ...
  deletedbcomplaint,
  getadmincomplaints,
  getadmincomplaintsallocation,
  getadmincomplaintsallocate,
  docomplaintsedit,
};
