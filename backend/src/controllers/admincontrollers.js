...
const usermodal = require("../models/complaints.js");
const usermodal2 = require("../models/usermodel.js");
const usermodal3 = require("../models/departmentdetails.js");

const admincomplaints = async (req, res) => {
  try{
...
const admincomplaintsallocation = async (req, res) => {
  try{
...
const admincomplaintsallocate = async (req, res) => {
  try{
...
const admincomplaintsedit = async (req, res) => {
...
const admingetdepartments = async(req,res)=>{
      try {
...
module.exports={admincomplaints,admincomplaintsallocate,admincomplaintsallocation,admincomplaintsedit,admingetdepartments,adminusersdelete,getstaffdetails}