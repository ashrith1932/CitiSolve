...
const { updatecomplaint } = require("./staffcontrollers.js");

const getcomplaintstatsforuser = async(req, res)=>{
...
module.exports={deletecomplaint,updatecomplaint,getcomplaintsforuser,getcomplaintstatsforuser,submitcomplaint};